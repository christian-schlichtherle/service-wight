  ...
  "A localized logger" when {
    ...
    "not debug-enabled" should {
      "not forward the logging call" in {
        reset(delegate)
        logger debug "0"
        verify(delegate, never()) debug any[String]
      }
    }
    ...
    "not info-enabled" should {
      "not forward the logging call" in {
        reset(delegate)
        logger info "0"
        verify(delegate, never()) info any[String]
      }
    }
    ...
    "not warn-enabled" should {
      "not forward the logging call" in {
        reset(delegate)
        logger warn "0"
        verify(delegate, never()) warn any[String]
      }
    }
    ...
    "not error-enabled" should {
      "not forward the logging call" in {
        reset(delegate)
        logger error "0"
        verify(delegate, never()) error any[String]
      }
    }
...
private object LocalizedLoggerTest {

  val Bundle: ListResourceBundle = new ListResourceBundle {
